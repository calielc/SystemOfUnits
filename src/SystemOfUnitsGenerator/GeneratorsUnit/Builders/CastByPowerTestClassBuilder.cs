...
namespace SystemOfUnitsGenerator.GeneratorsUnit.Builders {
    ...
    internal sealed class CastByPowerTestClassBuilder : IContentFileBuilder {
        ...
        public IReadOnlyList<ContextWithCastByPower> OtherContexts { get; }
        ...
        public IContentFile BuildFile() {
            ...
            for (var idxOther = 0; idxOther < OtherContexts.Count; idxOther++) {
                ...
                foreach (var testCase in ThisContext.TestCases) {
                    contentBuilder.AppendLine($"        [TestCase({testCase.Input,23:e15}, {testCase.Expected[idxOther],23:e15})]");
                }
