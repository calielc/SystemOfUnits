...
namespace SystemOfUnitsTests.Area.SquareMetre {
    using SquareCentimetre = SystemOfUnits.Area.SquareMetre.SquareCentimetre;

    partial class SquareCentimetreTest {
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-004, -5.000000000000000e+036)]
        [TestCase( 1.370000000000000e-003,  1.370000000000000e+037)]
        [TestCase( 9.999999999999999e-041,  1.000000000000000e+000)]
        [TestCase( 1.000000000000000e+032,  9.999999999999999e+071)]
        public void Should_cast_from_SquareExametre(double squareExametreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareExametreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-006)]
        ...
        public void Should_cast_from_SquarePetametre(double squarePetametreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squarePetametreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-012)]
        ...
        public void Should_cast_from_SquareTerametre(double squareTerametreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareTerametreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-018)]
        ...
        public void Should_cast_from_SquareGigametre(double squareGigametreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareGigametreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  9.999999999999999e-025)]
        ...
        public void Should_cast_from_SquareMegametre(double squareMegametreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareMegametreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-030)]
        ...
        public void Should_cast_from_SquareKilometre(double squareKilometreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareKilometreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-032)]
        [TestCase( 1.000000000000000e+032,  1.000000000000000e+040)]
        public void Should_cast_from_SquareHectometre(double squareHectometreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareHectometreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  9.999999999999999e-035)]
        ...
        public void Should_cast_from_SquareDecametre(double squareDecametreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareDecametreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  9.999999999999999e-037)]
        [TestCase( 1.000000000000000e+032,  1.000000000000000e+036)]
        public void Should_cast_from_SquareMetre(double squareMetreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareMetreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase(-5.000000000000000e-004, -5.000000000000000e-002)]
        [TestCase( 1.370000000000000e-003,  1.370000000000000e-001)]
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-038)]
        [TestCase( 1.000000000000000e+032,  1.000000000000000e+034)]
        public void Should_cast_from_SquareDecimetre(double squareDecimetreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareDecimetreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase(-5.000000000000000e-004, -5.000000000000000e-006)]
        [TestCase( 1.370000000000000e-003,  1.370000000000000e-005)]
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-042)]
        ...
        public void Should_cast_from_SquareMillimetre(double squareMillimetreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareMillimetreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-048)]
        [TestCase( 1.000000000000000e+032,  1.000000000000000e+024)]
        public void Should_cast_from_SquareMicrometre(double squareMicrometreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareMicrometreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-054)]
        ...
        public void Should_cast_from_SquareNanometre(double squareNanometreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareNanometreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-060)]
        ...
        public void Should_cast_from_SquarePicometre(double squarePicometreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squarePicometreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-066)]
        ...
        public void Should_cast_from_SquareFemtometre(double squareFemtometreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareFemtometreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
        ...
        [TestCase( 9.999999999999999e-041,  1.000000000000000e-072)]
        ...
        public void Should_cast_from_SquareAttometre(double squareAttometreValue, double expectedValue) {
            ...
            SquareCentimetre actual = squareAttometreInstance;
            Assert.IsAssignableFrom<SquareCentimetre>(actual);
