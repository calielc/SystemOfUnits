...
namespace SystemOfUnitsTests.Area.SquareMetre {
    ...
    partial class SquareFemtometreTest {
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-030, -5.000000000000000e+036)]
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+037)]
        [TestCase( 1.000000000000000e-066,  1.000000000000000e+000)]
        [TestCase( 1.000000000000000e+006,  9.999999999999999e+071)]
        public void Should_cast_from_SquareExametre(double squareExametreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareExametreInstance;
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+031)]
        ...
        public void Should_cast_from_SquarePetametre(double squarePetametreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squarePetametreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+025)]
        ...
        public void Should_cast_from_SquareTerametre(double squareTerametreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareTerametreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+019)]
        ...
        public void Should_cast_from_SquareGigametre(double squareGigametreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareGigametreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+013)]
        [TestCase( 1.000000000000000e-066,  9.999999999999999e-025)]
        ...
        public void Should_cast_from_SquareMegametre(double squareMegametreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareMegametreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+007)]
        ...
        public void Should_cast_from_SquareKilometre(double squareKilometreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareKilometreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+005)]
        [TestCase( 1.000000000000000e-066,  1.000000000000000e-032)]
        [TestCase( 1.000000000000000e+006,  1.000000000000000e+040)]
        public void Should_cast_from_SquareHectometre(double squareHectometreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareHectometreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+003)]
        [TestCase( 1.000000000000000e-066,  9.999999999999999e-035)]
        ...
        public void Should_cast_from_SquareDecametre(double squareDecametreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareDecametreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e+001)]
        [TestCase( 1.000000000000000e-066,  9.999999999999999e-037)]
        ...
        public void Should_cast_from_SquareMetre(double squareMetreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareMetreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.000000000000000e+006,  1.000000000000000e+034)]
        public void Should_cast_from_SquareDecimetre(double squareDecimetreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareDecimetreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase(-5.000000000000000e-030, -5.000000000000000e-004)]
        [TestCase( 1.370000000000000e-029,  1.370000000000000e-003)]
        [TestCase( 1.000000000000000e-066,  9.999999999999999e-041)]
        ...
        public void Should_cast_from_SquareCentimetre(double squareCentimetreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareCentimetreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        public void Should_cast_from_SquareMillimetre(double squareMillimetreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareMillimetreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-030, -5.000000000000000e-012)]
        [TestCase( 1.370000000000000e-029,  1.370000000000000e-011)]
        ...
        public void Should_cast_from_SquareMicrometre(double squareMicrometreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareMicrometreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-030, -5.000000000000000e-018)]
        [TestCase( 1.370000000000000e-029,  1.370000000000000e-017)]
        ...
        public void Should_cast_from_SquareNanometre(double squareNanometreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareNanometreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 1.370000000000000e-029,  1.370000000000000e-023)]
        ...
        public void Should_cast_from_SquarePicometre(double squarePicometreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squarePicometreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-030, -5.000000000000000e-036)]
        [TestCase( 1.370000000000000e-029,  1.370000000000000e-035)]
        [TestCase( 1.000000000000000e-066,  1.000000000000000e-072)]
        ...
        public void Should_cast_from_SquareAttometre(double squareAttometreValue, double expectedValue) {
            ...
            SquareFemtometre actual = squareAttometreInstance;
            Assert.IsAssignableFrom<SquareFemtometre>(actual);
