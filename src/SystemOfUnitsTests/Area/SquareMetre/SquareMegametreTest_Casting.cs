...
namespace SystemOfUnitsTests.Area.SquareMetre {
    ...
    partial class SquareMegametreTest {
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e+012, -5.000000000000000e+036)]
        [TestCase( 1.370000000000000e+013,  1.370000000000000e+037)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e+000)]
        [TestCase( 1.000000000000000e+048,  9.999999999999999e+071)]
        public void Should_cast_from_SquareExametre(double squareExametreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareExametreInstance;
        ...
        [TestCase( 1.370000000000000e+013,  1.370000000000000e+031)]
        ...
        public void Should_cast_from_SquarePetametre(double squarePetametreValue, double expectedValue) {
            ...
            SquareMegametre actual = squarePetametreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        public void Should_cast_from_SquareTerametre(double squareTerametreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareTerametreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        public void Should_cast_from_SquareGigametre(double squareGigametreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareGigametreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        public void Should_cast_from_SquareKilometre(double squareKilometreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareKilometreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 1.370000000000000e+013,  1.370000000000000e+005)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-032)]
        [TestCase( 1.000000000000000e+048,  1.000000000000000e+040)]
        public void Should_cast_from_SquareHectometre(double squareHectometreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareHectometreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 1.370000000000000e+013,  1.370000000000000e+003)]
        [TestCase( 9.999999999999999e-025,  9.999999999999999e-035)]
        ...
        public void Should_cast_from_SquareDecametre(double squareDecametreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareDecametreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 1.000000000000000e+048,  1.000000000000000e+036)]
        public void Should_cast_from_SquareMetre(double squareMetreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareMetreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase(-5.000000000000000e+012, -5.000000000000000e-002)]
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-001)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-038)]
        [TestCase( 1.000000000000000e+048,  1.000000000000000e+034)]
        public void Should_cast_from_SquareDecimetre(double squareDecimetreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareDecimetreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase(-5.000000000000000e+012, -5.000000000000000e-004)]
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-003)]
        [TestCase( 9.999999999999999e-025,  9.999999999999999e-041)]
        ...
        public void Should_cast_from_SquareCentimetre(double squareCentimetreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareCentimetreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase(-5.000000000000000e+012, -5.000000000000000e-006)]
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-005)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-042)]
        ...
        public void Should_cast_from_SquareMillimetre(double squareMillimetreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareMillimetreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-011)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-048)]
        [TestCase( 1.000000000000000e+048,  1.000000000000000e+024)]
        public void Should_cast_from_SquareMicrometre(double squareMicrometreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareMicrometreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e+012, -5.000000000000000e-018)]
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-017)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-054)]
        ...
        public void Should_cast_from_SquareNanometre(double squareNanometreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareNanometreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-023)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-060)]
        ...
        public void Should_cast_from_SquarePicometre(double squarePicometreValue, double expectedValue) {
            ...
            SquareMegametre actual = squarePicometreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e+012, -5.000000000000000e-030)]
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-029)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-066)]
        ...
        public void Should_cast_from_SquareFemtometre(double squareFemtometreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareFemtometreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e+012, -5.000000000000000e-036)]
        [TestCase( 1.370000000000000e+013,  1.370000000000000e-035)]
        [TestCase( 9.999999999999999e-025,  1.000000000000000e-072)]
        ...
        public void Should_cast_from_SquareAttometre(double squareAttometreValue, double expectedValue) {
            ...
            SquareMegametre actual = squareAttometreInstance;
            Assert.IsAssignableFrom<SquareMegametre>(actual);
