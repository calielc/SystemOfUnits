...
namespace SystemOfUnitsTests.Area.SquareMetre {
    using SquareMicrometre = SystemOfUnits.Area.SquareMetre.SquareMicrometre;

    partial class SquareMicrometreTest {
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-012, -5.000000000000000e+036)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e+037)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e+000)]
        [TestCase( 1.000000000000000e+024,  9.999999999999999e+071)]
        public void Should_cast_from_SquareExametre(double squareExametreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareExametreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-012, -5.000000000000000e+030)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e+031)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-006)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+066)]
        public void Should_cast_from_SquarePetametre(double squarePetametreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squarePetametreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 1.370000000000000e-011,  1.370000000000000e+025)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-012)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+060)]
        public void Should_cast_from_SquareTerametre(double squareTerametreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareTerametreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-018)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+054)]
        public void Should_cast_from_SquareGigametre(double squareGigametreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareGigametreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 1.000000000000000e-048,  9.999999999999999e-025)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+048)]
        public void Should_cast_from_SquareMegametre(double squareMegametreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareMegametreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-030)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+042)]
        public void Should_cast_from_SquareKilometre(double squareKilometreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareKilometreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-012, -5.000000000000000e+004)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e+005)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-032)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+040)]
        public void Should_cast_from_SquareHectometre(double squareHectometreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareHectometreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 1.000000000000000e-048,  9.999999999999999e-035)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+038)]
        public void Should_cast_from_SquareDecametre(double squareDecametreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareDecametreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 1.000000000000000e-048,  9.999999999999999e-037)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+036)]
        public void Should_cast_from_SquareMetre(double squareMetreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareMetreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase(-5.000000000000000e-012, -5.000000000000000e-002)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e-001)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-038)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+034)]
        public void Should_cast_from_SquareDecimetre(double squareDecimetreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareDecimetreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase(-5.000000000000000e-012, -5.000000000000000e-004)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e-003)]
        [TestCase( 1.000000000000000e-048,  9.999999999999999e-041)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+032)]
        public void Should_cast_from_SquareCentimetre(double squareCentimetreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareCentimetreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase(-5.000000000000000e-012, -5.000000000000000e-006)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e-005)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-042)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+030)]
        public void Should_cast_from_SquareMillimetre(double squareMillimetreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareMillimetreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-054)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+018)]
        public void Should_cast_from_SquareNanometre(double squareNanometreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareNanometreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-012, -5.000000000000000e-024)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e-023)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-060)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+012)]
        public void Should_cast_from_SquarePicometre(double squarePicometreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squarePicometreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-012, -5.000000000000000e-030)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e-029)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-066)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+006)]
        public void Should_cast_from_SquareFemtometre(double squareFemtometreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareFemtometreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
        ...
        [TestCase( 0.000000000000000e+000,  0.000000000000000e+000)]
        [TestCase(-5.000000000000000e-012, -5.000000000000000e-036)]
        [TestCase( 1.370000000000000e-011,  1.370000000000000e-035)]
        [TestCase( 1.000000000000000e-048,  1.000000000000000e-072)]
        [TestCase( 1.000000000000000e+024,  1.000000000000000e+000)]
        public void Should_cast_from_SquareAttometre(double squareAttometreValue, double expectedValue) {
            ...
            SquareMicrometre actual = squareAttometreInstance;
            Assert.IsAssignableFrom<SquareMicrometre>(actual);
