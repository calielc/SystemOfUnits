...
namespace SystemOfUnitsTests.Length.Imperial {
    ...
    public sealed partial class YardTest {
        [Test]
        public void Should_have_symbol_on_class() {
            Assert.AreEqual("yd", Yard.Symbol);
        }
        ...
        public void Should_have_a_symbol(double value) {
            IUnit actual = new Yard(value);

            Assert.AreEqual(Yard.Symbol, actual.Symbol);
        }
        ...
        public void Should_clone(double value) {
            ...
            ICloneable cloneable = new Yard(value);
        ...
        public void Should_compare_with_same_value(double value) {
            var baseInstance = new Yard(value);
            var otherInstance = new Yard(value);
        ...
        public void Should_compare_with_smaller_value(double baseValue, double smallerValue) {
            var baseInstance = new Yard(baseValue);
            var smallerInstance = new Yard(smallerValue);
        ...
        public void Should_compare_with_bigger_value(double baseValue, double biggerValue) {
            var baseInstance = new Yard(baseValue);
            var biggerInstance = new Yard(biggerValue);
