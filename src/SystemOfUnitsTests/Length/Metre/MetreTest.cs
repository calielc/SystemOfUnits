...
namespace SystemOfUnitsTests.Length.Metre {
    ...
    public sealed partial class MetreTest {
        [Test]
        public void Should_have_symbol_on_class() {
            Assert.AreEqual("m", Metre.Symbol);
        }
        ...
        public void Should_have_a_symbol(double value) {
            IUnit actual = new Metre(value);

            Assert.AreEqual(Metre.Symbol, actual.Symbol);
        }
        ...
        public void Should_clone(double value) {
            ...
            ICloneable cloneable = new Metre(value);
