...
namespace SystemOfUnitsTests.Others {
    using Percentage = SystemOfUnits.Others.Percentage;

    [Parallelizable(ParallelScope.Default)]
    public sealed partial class PercentageTest {
        [Test]
        public void Should_have_symbol_on_class() {
            Assert.AreEqual("%", Percentage.Symbol);
        }
        ...
        public void Should_initialize_instance(double value) {
            var actual = new Percentage(value);

            Assert.IsAssignableFrom<Percentage>(actual);
        ...
        public void Should_have_a_symbol(double value) {
            IUnit actual = new Percentage(value);

            Assert.AreEqual(Percentage.Symbol, actual.Symbol);
        }
        ...
        public void Should_clone(double value) {
            var expected = new Percentage(value);

            ICloneable cloneable = new Percentage(value);
        ...
        public void Should_sum_two_instances(double leftValue, double rightValue, double expectedValue) {
            ...
            var leftInstance = new Percentage(leftValue);
            var rightInstance = new Percentage(rightValue);
        ...
        public void Should_multiply_instance_by_double(double leftValue, double rightValue, double expectedValue) {
            ...
            var instance = new Percentage(leftValue);
        ...
        public void Should_multiply_double_by_instance(double leftValue, double rightValue, double expectedValue) {
            ...
            var instance = new Percentage(rightValue);
        ...
        public void Should_format_string(string format, string mask) {
            ...
            var instance = new Percentage(1.757899e2);
