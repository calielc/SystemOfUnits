...
namespace SystemOfUnitsTests.Time {
    ...
    public sealed partial class MillisecondTest {
        [Test]
        public void Should_have_symbol_on_class() {
            Assert.AreEqual("milliseconds", Millisecond.Symbol);
        }
        ...
        public void Should_have_a_symbol(double value) {
            IUnit actual = new Millisecond(value);

            Assert.AreEqual(Millisecond.Symbol, actual.Symbol);
        }
        ...
        public void Should_clone(double value) {
            ...
            ICloneable cloneable = new Millisecond(value);
