...
namespace SystemOfUnitsTests.Volume.CubicMetre {
    ...
    public sealed partial class CubicCentimetreTest {
        [Test]
        public void Should_have_symbol_on_class() {
            Assert.AreEqual("cm³", CubicCentimetre.Symbol);
        }
        ...
        public void Should_initialize_instance(double value) {
            var actual = new CubicCentimetre(value);
        ...
        public void Should_have_a_symbol(double value) {
            IUnit actual = new CubicCentimetre(value);

            Assert.AreEqual(CubicCentimetre.Symbol, actual.Symbol);
        }

        [TestCaseSource(nameof(CasesValues))]
        public void Should_clone(double value) {
            var expected = new CubicCentimetre(value);

            ICloneable cloneable = new CubicCentimetre(value);
        ...
        public void Should_cast_from_double(double value) {
            ...
            var actual = (CubicCentimetre)value;
        ...
        public void Should_cast_to_double(double value) {
            var instance = new CubicCentimetre(value);
        ...
        public void Should_compare_with_same_value(double value) {
            var baseInstance = new CubicCentimetre(value);
            var otherInstance = new CubicCentimetre(value);
        ...
        public void Should_compare_with_smaller_value(double baseValue, double smallerValue) {
            var baseInstance = new CubicCentimetre(baseValue);
            var smallerInstance = new CubicCentimetre(smallerValue);
        ...
        public void Should_compare_with_bigger_value(double baseValue, double biggerValue) {
            var baseInstance = new CubicCentimetre(baseValue);
            var biggerInstance = new CubicCentimetre(biggerValue);
        ...
        public void Should_compare_with_another_type_of_instance(double value) {
            var instance1 = new CubicCentimetre(value);
        ...
        public void Should_sum_two_instances(double leftValue, double rightValue, double expectedValue) {
            var expected = new CubicCentimetre(expectedValue);

            var leftInstance = new CubicCentimetre(leftValue);
            var rightInstance = new CubicCentimetre(rightValue);
        ...
        public void Should_multiply_instance_by_double(double leftValue, double rightValue, double expectedValue) {
            ...
            var instance = new CubicCentimetre(leftValue);
        ...
        public void Should_multiply_double_by_instance(double leftValue, double rightValue, double expectedValue) {
            ...
            var instance = new CubicCentimetre(rightValue);
        ...
        public void Should_format_string(string format, string mask) {
            ...
            var instance = new CubicCentimetre(1.757899e2);
